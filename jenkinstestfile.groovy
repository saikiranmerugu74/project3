            ...
            steps {
                script {
                    sshagent(['deployserver']) {
                        ...
                        //sh "ssh -o StrictHostKeyChecking=no azureuser@${TEST_VM} 'sudo rm -r project3'"
                        ...
                        sh "ssh -o StrictHostKeyChecking=no azureuser@${TEST_VM} 'terraform destroy -auto-approve'"
                        }
